 ...
 * 接口aop
 * @author fromfield
 * @create 2017-10-31 16:35
 **/

@Aspect
@Component
public class PracticeAspect {
    private static final Logger LOGGER = LoggerFactory.getLogger(PracticeAspect.class);
    ...
    @AfterReturning(returning = "object", pointcut = "practiceLog()")
    public void doAfterReturning(Object object) throws Throwable {
        // 处理完请求，返回内容
        LOGGER.info("返回--RESPONSE : " + object);
    }
}
